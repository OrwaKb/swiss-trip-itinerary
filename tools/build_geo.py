...
STOPS = [
    ...
    dict(slug="trummelbach", name="Trümmelbach Falls", kind="swap",
         ...
         what="Ten glacier falls inside the mountain, reached by a lift built into the rock - but stairs past halfway and permanently wet, so adults only.",
         osm=('nwr[name~"mmelbach",i]', 2000)),
    dict(slug="mannlichen-top", name="Männlichen", kind="swap",
         lat=46.61360, lon=7.94110, days=[],
         what="A spare day with the parents: gondola up from the Terminal, the almost level Panoramaweg across, cog railway down from Kleine Scheidegg.",
...
LEGS = [
    ...
    dict(day=2, mode="walk", a="rigi-kulm", b="rigi-kanzeli",
         label="For the adults: 4 km down to Kaltbad, about an hour and a quarter"),
